...
# List of acceptable file types that can be uploaded to a given object via arbitrary file upoad
...
AUTH_LDAP_USER_SEARCH = LDAPSearch(
    "ou=Users,ou=DevOps,ou=Employees,ou=SPB,ou=corp,dc=corp,dc=ekassir,dc=com", ldap.SCOPE_SUBTREE, "(sAMAccountName=%(user)s)"
)
...
AUTH_LDAP_GROUP_SEARCH = LDAPSearch(
    "ou=DevOps,ou=Security,ou=Groups,ou=Other,ou=SPB,ou=corp,dc=corp,dc=ekassir,dc=com",
    ldap.SCOPE_SUBTREE,
...
#AUTH_LDAP_REQUIRE_GROUP = "ou=users,ou=devops,ou=employees,ou=spb,ou=corp,dc=corp,dc=ekassir,dc=com"

AUTH_LDAP_USER_FLAGS_BY_GROUP = {
    "is_active": "CN=VPN Users,OU=Groups,OU=Other,OU=SPB,OU=corp,DC=corp,DC=ekassir,DC=com",
    "is_staff": "CN=VPN Users,OU=Groups,OU=Other,OU=SPB,OU=corp,DC=corp,DC=ekassir,DC=com",
    "is_superuser": "cn=DevOps_ADM,ou=DevOps,ou=Security,ou=Groups,ou=Other,ou=SPB,ou=corp,dc=corp,dc=ekassir,dc=com",
}
